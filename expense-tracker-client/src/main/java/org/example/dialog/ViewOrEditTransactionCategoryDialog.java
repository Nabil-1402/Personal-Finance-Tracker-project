...
public class ViewOrEditTransactionCategoryDialog extends CustomDialog{
    ...
    public ViewOrEditTransactionCategoryDialog(User user, DashbordController dashbordController){
        super(user);
    ...
    private ScrollPane createMainContainerContent(){
        ...
        for(TransactionCategory transactionCategory: transactionCategories){
            CategoryComponent categoryComponent = new CategoryComponent(dashbordController, transactionCategory);
